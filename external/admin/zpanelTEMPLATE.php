    ...
    <div id='wrapper'>
        ...
        <nav class='navbar navbar-inverse navbar-fixed-top' role='navigation'>
            ...
            <div class='navbar-header'>
                ...
                <a class='navbar-brand' href='./external/admin/index.html'>SB Admin</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class='collapse navbar-collapse navbar-ex1-collapse'>
                <ul class='nav navbar-nav side-nav'>
                    <li class='active'>
                        <a href='./external/admin/index.html'><i class='fa fa-fw fa-dashboard'></i> Dashboard</a>
                    </li>
                    <li>
                        <a href='./external/admin/charts.html'><i class='fa fa-fw fa-bar-chart-o'></i> Charts</a>
                    </li>
                    <li>
                        <a href='./external/admin/tables.html'><i class='fa fa-fw fa-table'></i> Tables</a>
                    </li>
                    <li>
                        <a href='./external/admin/forms.html'><i class='fa fa-fw fa-edit'></i> Forms</a>
                    </li>
                    <li>
                        <a href='./external/admin/bootstrap-elements.html'><i class='fa fa-fw fa-desktop'></i> Bootstrap Elements</a>
                    </li>
                    <li>
                        <a href='./external/admin/bootstrap-grid.html'><i class='fa fa-fw fa-wrench'></i> Bootstrap Grid</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href='./external/admin/blank-page.html'><i class='fa fa-fw fa-file'></i> Blank Page</a>
                    </li>
                    <li>
                        <a href='./external/admin/index-rtl.html'><i class='fa fa-fw fa-dashboard'></i> RTL Dashboard</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
