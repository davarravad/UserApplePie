...
$result02 = mysqli_query($GLOBALS["___mysqli_ston"], $query02)
	or die ("Couldn't ececute query. 46552120");
	...
	echo "<ul class='list-group'>";
		...
		echo "<li class='list-group-item'>";
			...
			if($view_only_one == "TRUE"){
					$ed_com_url = "$view_status_link&offset=$offset#statcom$id";
			}else{
					$ed_com_url = "${site_url_link}community/mystatus/?offset=$offset#statcom$id";
			}
			$com_uid = $statcom_uid;
		...
		echo "<li class='list-group-item'>";
			...
			if($view_only_one == "TRUE"){
					$sweet_url = "$view_status_link&offset=$offset#statcom$id";
			}else{
					$sweet_url = "${site_url_link}community/mystatus/?offset=$offset#statcom$id";
			}
