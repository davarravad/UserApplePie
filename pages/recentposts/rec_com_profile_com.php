...
//Displays Status updates
			...
			echo "<div class='panel panel-info'>";
				echo "<div class='panel-heading'>";
					...
					echo " <a href='${site_url_link}member/$com_id/#comment_new'>Commented</a> on...</strong> ";
				echo "</div>";
