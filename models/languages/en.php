...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_DISPLAY_INVALID_CHARACTERS"	=> "Display name can only include alpha-numeric characters, and NO spaces.",
	...
	"ACCOUNT_ACTIVATION_MESSAGE"		=> "You will need to activate your account before you can login. <br> Please follow the link below to activate your account. <br>
		<a href='http://%m1%activate_account/?token=%m2%'>http://%m1%activate_account/?token=%m2%</a><br><br> 
		OR Copy and Paste The Following URL to your address bar: http://%m1%activate_account/?token=%m2%",							
...
$lang = array_merge($lang,array(
	...
	"CONFIG_DESCRIPT_CHAR_LIMIT"		=> "Site Description must be between %m1% and %m2% characters in length",
	"CONFIG_KEYWORDS_CHAR_LIMIT"		=> "Site Keywords must be between %m1% and %m2% characters in length",
	"CONFIG_URL_LINK_CHAR_LIMIT"		=> "Site URL Link must be between %m1% and %m2% characters in length",
	"CONFIG_URL_M_CHAR_LIMIT"		=> "Site Mobile URL must be between %m1% and %m2% characters in length",
	"CONFIG_SITE_DIR_CHAR_LIMIT"		=> "Site Main Directory must be between %m1% and %m2% characters in length",
	"CONFIG_FOLDER_DIR_CHAR_LIMIT"		=> "Site Folder Directory must be between %m1% and %m2% characters in length",
	"CONFIG_DEBUG_CHAR_LIMIT"		=> "Site Debug must be between %m1% and %m2% characters in length",
	"CONFIG_RECAP_SITEKEY_CHAR_LIMIT"		=> "reCAPTCHA Site Key must be between %m1% and %m2% characters in length",
	"CONFIG_RECAP_SECRETKEY_CHAR_LIMIT"		=> "reCAPTCHA Secret Key must be between %m1% and %m2% characters in length",
	...
	"CONFIG_INVALID_URL_START"		=> "Please include the start http:// in your site's URL",
...
//Miscellaneous
$lang = array_merge($lang,array(
	"CAPTCHA_FAIL"				=> "Sorry, The reCAPTCHA was not entered correctly! Please try again!",
	"CONFIRM"				=> "Confirm",
	"DENY"					=> "Deny",
	"SUCCESS"				=> "Success",
	"ERROR"					=> "Error",
...
$lang = array_merge($lang,array(
	...
	"PERMISSION_COLOR_UPDATE"		=> "Permission level color changed to `%m1%`",
	"PERMISSION_WEIGHT_UPDATE"		=> "Permission level weight changed to `%m1%`",
